...
export const TAB_DEFINITIONS: TabDefinition[] = [
  ...
  },
  {
    ...
    headers: [
      ...
      'extractedAt',
      'extractedRawJson',
      // 아래부터 legacy Gemini responseSchema(counseling-manager/code.gs.txt:4046-4087)와
      // 동일한 38개 키 — functions/_lib/assessmentSheet.ts의 ASSESSMENT_EXTRACTED_FIELDS와
      // 순서까지 맞춘다(중복 유지보수 지점이지만, 이 파일은 다른 _lib 모듈을 import하지
      // 않는 기존 관례를 따른다).
      'studentName',
      'schoolType',
      'grade',
